...
/*    static inline void UTM(double lat, double lon, double *x, double *y)
    ...
    static inline void LLtoUTM(double Lat, double Long, 
    ...
    static inline void UTMtoLL(const double UTMNorthing, const double UTMEasting,const int UTMzonenum,
                               double& Lat,  double& Long )
    {
        ...
        char UTMZone[6];
        sprintf(UTMZone, "%d%c", UTMzonenum, 'N');
