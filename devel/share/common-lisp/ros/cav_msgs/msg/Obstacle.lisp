...
(cl:defmethod cl:initialize-instance :after ((m <Obstacle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Obstacle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cav_msgs-msg:<Obstacle> is deprecated: use cav_msgs-msg:Obstacle instead.")))
...
(cl:defmethod id-val ((m <Obstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cav_msgs-msg:id-val is deprecated.  Use cav_msgs-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'type-val :lambda-list '(m))
(cl:defmethod type-val ((m <Obstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cav_msgs-msg:type-val is deprecated.  Use cav_msgs-msg:type instead.")
  (type m))

(cl:ensure-generic-function 'radius-val :lambda-list '(m))
(cl:defmethod radius-val ((m <Obstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cav_msgs-msg:radius-val is deprecated.  Use cav_msgs-msg:radius instead.")
  (radius m))

(cl:ensure-generic-function 'x_global-val :lambda-list '(m))
(cl:defmethod x_global-val ((m <Obstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cav_msgs-msg:x_global-val is deprecated.  Use cav_msgs-msg:x_global instead.")
  (x_global m))

(cl:ensure-generic-function 'y_global-val :lambda-list '(m))
(cl:defmethod y_global-val ((m <Obstacle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cav_msgs-msg:y_global-val is deprecated.  Use cav_msgs-msg:y_global instead.")
  (y_global m))

(cl:ensure-generic-function 'speed_x-val :lambda-list '(m))
(cl:defmethod speed_x-val ((m <Obstacle>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Obstacle>)))
  ...
  "a54a7e58941fdabf5915ce1f4cd97ed5")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Obstacle)))
  "Returns md5sum for a message object of type 'Obstacle"
  "a54a7e58941fdabf5915ce1f4cd97ed5")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Obstacle>)))
  ...
  (cl:format cl:nil "float64 	timestamp   #ros time~%int32 		id~%int16 		type        #refer to below definition       ~%float64     radius      # m, radius for object circle~%~%float64 	x_global   #m, in the same coordinate system of the ego car~%float64 	y_global   #m, in the same coordinate system of the ego car~%~%float64 	speed_x    #not official definition~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Obstacle)))
  "Returns full string definition for message of type 'Obstacle"
  (cl:format cl:nil "float64 	timestamp   #ros time~%int32 		id~%int16 		type        #refer to below definition       ~%float64     radius      # m, radius for object circle~%~%float64 	x_global   #m, in the same coordinate system of the ego car~%float64 	y_global   #m, in the same coordinate system of the ego car~%~%float64 	speed_x    #not official definition~%~%~%"))
